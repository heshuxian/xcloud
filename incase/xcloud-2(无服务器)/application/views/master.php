...
<html>
    <head>
        <meta charset="UTF-8">
        <title>X-Cloud - <?php echo $pageTitle?></title>
...
<!--         <link href="/public/css/morris/morris.css" rel="stylesheet" type="text/css" /> -->
		...
		<!-- Notyfy -->
		<link rel="stylesheet" href="/public/js/plugins/notyfy/jquery.notyfy.css"/>
		<link rel="stylesheet" href="/public/js/plugins/notyfy/themes/default.css"/>
        <!-- Daterange picker -->
...
<!--                                         <small>Member since Nov. 2012</small> -->
            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="/account/usermanage">
                                <i class="fa fa-th"></i> <span>人员管理</span>
                            </a>
                        </li>
                        <li>
                            <a href="/account/departmentmanage">
        ...
        <!-- BootBox -->
        <script type="text/javascript" src="/public/js/plugins/bootbox.js"></script>
        <!-- Morris.js charts -->
